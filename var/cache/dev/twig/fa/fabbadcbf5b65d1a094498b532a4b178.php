...
class __TwigTemplate_84b567141f15bcf6e7a18fff8ac643cb extends Template
{
    private $source;
    private $macros = [];
...
Symfony Twig Bridge to ensure that all applications building backends with EasyAdmin
use the same version of the templates, even those still using Symfony 4.4.
", "@EasyAdmin/symfony-form-themes/README.txt", "/var/storage/src/example/easy-admin/article2/vendor/easycorp/easyadmin-bundle/src/Resources/views/symfony-form-themes/README.txt");
    }
}
