...
class __TwigTemplate_5db1331ecf3717e3572a7a35ff1852fd extends Template
{
    private $source;
    private $macros = [];
...
{% for js_asset in assets %}
    ...
    {% endif %}
{% endfor %}
", "@EasyAdmin/includes/_js_assets.html.twig", "/var/storage/src/example/easy-admin/article2/vendor/easycorp/easyadmin-bundle/src/Resources/views/includes/_js_assets.html.twig");
    }
}
